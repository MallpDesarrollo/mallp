...
function Home() {
    return (React.createElement("div", { className: "grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]" },
        React.createElement("main", { className: "flex flex-col gap-[32px] row-start-2 items-center sm:items-start" },
            ...
            React.createElement("ol", { className: "list-inside list-decimal text-sm/6 text-center sm:text-left font-[family-name:var(--font-geist-mono)]" },
                React.createElement("li", { className: "mb-2 tracking-[-.01em]" },
                    "Get started by editing",
                    " ",
                    React.createElement("code", { className: "bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded font-[family-name:var(--font-geist-mono)] font-semibold" }, "src/app/page.tsx"),
                    "."),
                React.createElement("li", { className: "tracking-[-.01em]" }, "mallp.")),
